...
This will generate all the necessary .hack files from .asm files using
a python script.

Once this has been completed open up the Assembler (I'm assuming you
know how to do this part) and load up the .asm and corresponding hack
files and compare their output.
